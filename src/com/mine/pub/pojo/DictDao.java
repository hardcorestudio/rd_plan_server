...
public class DictDao 
{
	...
	{
		return Db.find("select * from z_pub_dict_main a where  a.status = '1'");
//		return null;
	}
	/**
	 * @查询字典子表
	...
	{
		return Db.find("select * from z_pub_dict a where a.id_main = ?  and  a.status = '1' order by dict_id asc" ,mainId);
//		return null;
	}
	/**
	 * @author woody
	...
	public static void initSession()
	{
		...
		List<Record> list = Db.find("select * from Z_IWOBO_SESSION");
