...
public class RoleDao extends BaseDao {
	...
	public Map<String, Object> queryRoleUser(String roleId, int pn, int ps, Object searchContent){
		...
		if("CSDWGLY".equals(roleId)){
			...
			sql = "from (select A.*,B.ROLE_ID from (select cast(c.OPERATORID as varchar(20)) as USER_ID, c.USERID as NAME, a.EP_ID,a.EP_NAME from ENTERPRISE a, AC_OPERATOR c where a.EP_ID = c.USERID and c.STATUS = 'running' and a.STATUS = '2' and a.IF_PRODUCE = '1' ) as A left join WOBO_USERROLE B on A.USER_ID = B.USER_ID and B.ROLE_ID = ?) as AA";
		}else{
